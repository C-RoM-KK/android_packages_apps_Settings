...
public class CRomSettings extends PreferenceActivity implements ButtonBarHandler {
    ...
    private static final String TAG = "CRom_Settings";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if ("com.android.settings.crom.START_NEW_FRAGMENT".equals(getIntent().getAction())) {
            String className = getIntent().getStringExtra("crom_fragment_name").toString();
            Class<?> cls = null;
            try {
    ...
    public void onBuildHeaders(List<Header> headers) {
        loadHeadersFromResource(R.xml.crom_headers, headers);
