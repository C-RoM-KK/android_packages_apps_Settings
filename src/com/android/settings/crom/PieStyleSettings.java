...
public class PieStyleSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPieBackgroundAlpha = (CromSeekBarPreference) findPreference(PREF_PIE_BACKGROUND_ALPHA);
        ...
        mPieControlSize = (CromSeekBarPreference) findPreference(PREF_PIE_CONTROL_SIZE);
