...
import com.android.settings.crom.ProgressBar;
import com.android.settings.crom.ScrollAnimationInterfaceSettings;
import com.android.settings.crom.fragments.AnimationControls;

import java.lang.Exception;
import java.util.ArrayList;

public class AnimTab extends SettingsPreferenceFragment {

    private static final String TAG = "Animation_Category";
    ...
    class NavigationAdapter extends FragmentPagerAdapter {
        ...
        public NavigationAdapter(FragmentManager fm) {
            super(fm);
            frags[0] = new ProgressBar();
            frags[1] = new ScrollAnimationInterfaceSettings();
